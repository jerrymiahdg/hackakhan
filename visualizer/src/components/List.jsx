  ...
  return (
    <div className="flex flex-col gap-5">
      {listAssignments.map((el, i) => (
        <div
          className="w-full bg-neutral-200 border border-neutral-300 p-5 rounded-2xl flex flex-col gap-5"
          key={i}
        >
          ...
          <div className="flex gap-5">
            ...
            <button
              className="p-2 border border-neutral-400 rounded-2xl text-center hover:bg-neutral-300 transition-all"
